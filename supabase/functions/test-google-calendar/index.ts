...
serve(async (req) => {
  ...
  try {
    ...
    const impersonateEmail = 'verkoop@auto-city.nl';
    ...
    return new Response(JSON.stringify({ 
      ...
      sharingInstructions: {
        ...
        steps: [
          "1. De calendar is nu toegankelijk via verkoop@auto-city.nl",
          "2. Alle medewerkers kunnen de calendar zien als ze ingelogd zijn met hun Auto City Google account",
          "3. Events worden aangemaakt in de primary calendar van verkoop@auto-city.nl",
