  ...
  try {
    ...
    switch (action) {
      case 'setup_service_account': {
        ...
        const accessToken = await getServiceAccountToken(credentials, 'verkoop@auto-city.nl');
        ...
        const { error } = await supabase
          ...
          .upsert({
            ...
            calendar_email: 'verkoop@auto-city.nl', // The impersonated email
            sync_enabled: true,
      ...
      case 'get_access_token': {
        ...
        const emailToImpersonate = impersonate_email || 'verkoop@auto-city.nl';
